...
void demo_create(void)
{
    ...
    lv_style_copy(&style_tv_btn_bg, &lv_style_pretty);//lv_style_plain
    ...
    //style_tv_btn_rel.text.color = LV_COLOR_GREEN;
    style_tv_btn_rel.text.font =&lv_font_dejavu_20;
    ...
    style_tv_btn_pr.body.border.width = 10;
    style_tv_btn_pr.text.color = LV_COLOR_RED;

    style_tv_btn_pr.text.font =&lv_font_dejavu_20;
    ...
    lv_tabview_set_style(tv, LV_TABVIEW_STYLE_BG, &style_tv_btn_bg);//主背景
#endif
    ...
    lv_tabview_set_style(tv, LV_TABVIEW_STYLE_BTN_REL, &style_tv_btn_rel);//按钮背景
...
static void write_create(lv_obj_t * parent)
{
    ...
    //style_ta.text.font = &lv_font_dejavu_10;
